...
class GameEngine:
  ...
  def _apply_item_effects(self, agent_state: AgentState, item: Item) -> AgentState:
    ...
    # assert agent_state.counter_attack_chance < 1, f"{agent_state.counter_attack_chance}"
    # assert agent_state.double_attack_chance < 1, f"{agent_state.double_attack_chance}"
    # assert agent_state.steal_chance < 1, f"{agent_state.steal_chance}"
    # assert agent_state.prevent_death_chance < 1, f"{agent_state.prevent_death_chance}"
    # assert agent_state.prevent_damage_chance < 1, f"{agent_state.prevent_damage_chance}"
